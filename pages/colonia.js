...
function CampingPage() {
  ...
  return (
    <Layout>
      <div className="bg-white listWidth text-center py-2 rounded text-xl mx-auto mt-5 mb-10">
        <h1 className="font-light text-2xl">Apartado Colonia</h1>
      </div>
      <div>
        <div className='flex flex-col justify-center listWidth mb-4 mx-auto'>
          <Link href={'/colonia/inscripciones'} className='bg-white text-gray-500 hover:shadow-lg hover:text-black hover:bg-gray-100 transition-all duration-500 py-2 rounded text-lg md:text-xl text-center w-full'>Incripciones</Link>
        </div>
        <div className='flex flex-col justify-center listWidth mb-4 mx-auto'>
          <button onClick={() => toggleSection()} className='bg-white text-gray-500 hover:shadow-lg hover:text-black hover:bg-gray-100 transition-all duration-500 py-2 rounded text-lg md:text-xl text-center w-full'>Editar Sección</button>
          {isToggleSection && (
            <EditSections
